...
_getprocessinfo:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  17:	e8 04 02 00 00       	call   220 <atoi>
    struct processInfo procInfo;
    getprocinfo(pid, &procInfo);
  1c:	5a                   	pop    %edx
  1d:	8d 55 f4             	lea    -0xc(%ebp),%edx
  20:	59                   	pop    %ecx
  21:	52                   	push   %edx
  22:	50                   	push   %eax
  23:	e8 1a 03 00 00       	call   342 <getprocinfo>
    printf(1,"%d\n",procInfo.pid);
  28:	83 c4 0c             	add    $0xc,%esp
  2b:	ff 75 f4             	pushl  -0xc(%ebp)
  2e:	68 48 07 00 00       	push   $0x748
  33:	6a 01                	push   $0x1
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 54 07 00 00 	movzbl 0x754(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 4c 07 00 00       	mov    $0x74c,%ebx
        while(*s != 0){
