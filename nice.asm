  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  4c:	51                   	push   %ecx
  4d:	51                   	push   %ecx
  4e:	68 92 07 00 00       	push   $0x792
  53:	6a 02                	push   $0x2
  55:	e8 c6 03 00 00       	call   420 <printf>
		exit();
  5a:	e8 63 02 00 00       	call   2c2 <exit>
	}
	chpr ( pid, priority );
  5f:	52                   	push   %edx
  60:	52                   	push   %edx
  61:	50                   	push   %eax
  62:	56                   	push   %esi
  63:	e8 02 03 00 00       	call   36a <chpr>
	exit();
  68:	e8 55 02 00 00       	call   2c2 <exit>
  6d:	66 90                	xchg   %ax,%ax
  6f:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb ac 07 00 00       	mov    $0x7ac,%ebx
        while(*s != 0){
