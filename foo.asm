  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  1c:	8b 41 04             	mov    0x4(%ecx),%eax
	if(argc < 2 )
  1f:	7f 5e                	jg     7f <main+0x7f>
		n = 1;  //default value
  21:	31 db                	xor    %ebx,%ebx
  23:	eb 22                	jmp    47 <main+0x47>
  ...
  28:	74 71                	je     9b <main+0x9b>
			printf(1, "Parent %d -child %d\n", getpid(), id );
  2a:	e8 83 03 00 00       	call   3b2 <getpid>
  2f:	56                   	push   %esi
  30:	50                   	push   %eax
	for ( k = 0; k < n; k++ ) {
  31:	83 c3 01             	add    $0x1,%ebx
			printf(1, "Parent %d -child %d\n", getpid(), id );
  34:	68 fc 07 00 00       	push   $0x7fc
  39:	6a 01                	push   $0x1
  3b:	e8 50 04 00 00       	call   490 <printf>
  40:	83 c4 10             	add    $0x10,%esp
	for ( k = 0; k < n; k++ ) {
  43:	39 df                	cmp    %ebx,%edi
  45:	7e 2a                	jle    71 <main+0x71>
		id = fork ();
  47:	e8 de 02 00 00       	call   32a <fork>
		if ( id < 0 ) {
  4c:	85 c0                	test   %eax,%eax
		id = fork ();
  4e:	89 c6                	mov    %eax,%esi
		if ( id < 0 ) {
  50:	79 d6                	jns    28 <main+0x28>
			printf(1, "%d failed in fork!\n", getpid() );
  52:	e8 5b 03 00 00       	call   3b2 <getpid>
  57:	83 ec 04             	sub    $0x4,%esp
	for ( k = 0; k < n; k++ ) {
  5a:	83 c3 01             	add    $0x1,%ebx
			printf(1, "%d failed in fork!\n", getpid() );
  5d:	50                   	push   %eax
  5e:	68 e8 07 00 00       	push   $0x7e8
  63:	6a 01                	push   $0x1
  65:	e8 26 04 00 00       	call   490 <printf>
  6a:	83 c4 10             	add    $0x10,%esp
	for ( k = 0; k < n; k++ ) {
  6d:	39 df                	cmp    %ebx,%edi
  6f:	7f d6                	jg     47 <main+0x47>
    ...
    if(id > 0){
  71:	85 f6                	test   %esi,%esi
  73:	7e 05                	jle    7a <main+0x7a>
        wait();
  75:	e8 c0 02 00 00       	call   33a <wait>
    }
  ...
  82:	ff 70 04             	pushl  0x4(%eax)
  85:	e8 36 02 00 00       	call   2c0 <atoi>
	if ( n < 0 || n > 20 )
  8a:	83 c4 10             	add    $0x10,%esp
  8d:	83 f8 14             	cmp    $0x14,%eax
	n = atoi ( argv[1] ); //from command line
  90:	89 c7                	mov    %eax,%edi
	if ( n < 0 || n > 20 )
  92:	76 3e                	jbe    d2 <main+0xd2>
		n = 2;
  94:	bf 02 00 00 00       	mov    $0x2,%edi
  99:	eb 86                	jmp    21 <main+0x21>
			printf(1, "Child-%d\n",getpid() );
  9b:	e8 12 03 00 00       	call   3b2 <getpid>
  a0:	52                   	push   %edx
  a1:	50                   	push   %eax
  a2:	68 11 08 00 00       	push   $0x811
  a7:	6a 01                	push   $0x1
  a9:	e8 e2 03 00 00       	call   490 <printf>
			for ( z = 0; z < 8000000.0; z += 0.01 )
  ae:	d9 ee                	fldz   
			printf(1, "Child-%d\n",getpid() );
  b0:	83 c4 10             	add    $0x10,%esp
			for ( z = 0; z < 8000000.0; z += 0.01 )
  b3:	dd 05 20 08 00 00    	fldl   0x820
  b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  c0:	dc c1                	fadd   %st,%st(1)
  c2:	d9 05 28 08 00 00    	flds   0x828
  c8:	df ea                	fucomip %st(2),%st
  ca:	77 f4                	ja     c0 <main+0xc0>
  cc:	dd d8                	fstp   %st(0)
  ce:	dd d8                	fstp   %st(0)
  d0:	eb a8                	jmp    7a <main+0x7a>
	for ( k = 0; k < n; k++ ) {
  d2:	85 c0                	test   %eax,%eax
  d4:	0f 85 47 ff ff ff    	jne    21 <main+0x21>
  da:	eb 9e                	jmp    7a <main+0x7a>
  dc:	66 90                	xchg   %ax,%ax
  de:	66 90                	xchg   %ax,%ax
