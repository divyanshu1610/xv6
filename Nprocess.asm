...
_Nprocess:     file format elf32-i386
  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  21:	31 f6                	xor    %esi,%esi
	...
	for ( k = 0; k < n; k++ ) {
		id = fork ();
  23:	e8 02 03 00 00       	call   32a <fork>
		if ( id < 0 ) {
  28:	85 c0                	test   %eax,%eax
		id = fork ();
  2a:	89 c3                	mov    %eax,%ebx
		if ( id < 0 ) {
  2c:	0f 88 85 00 00 00    	js     b7 <main+0xb7>
			printf(1, "%d failed in fork!\n", getpid() );
		} else if ( id > 0 ) { //parent
  32:	75 3c                	jne    70 <main+0x70>
			printf(1, "Parent %d -child %d\n", getpid(), id );
			continue;
		} else {  // child
			printf(1, "Child-%d\n",getpid() );
  34:	e8 79 03 00 00       	call   3b2 <getpid>
  39:	83 ec 04             	sub    $0x4,%esp
  3c:	50                   	push   %eax
  3d:	68 11 08 00 00       	push   $0x811
  42:	6a 01                	push   $0x1
  ...
  4b:	83 c4 10             	add    $0x10,%esp
			for ( z = 0; z < 8000000.0; z += 0.01 )
  4e:	dd 05 20 08 00 00    	fldl   0x820
  54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  58:	dc c1                	fadd   %st,%st(1)
  5a:	d9 05 28 08 00 00    	flds   0x828
  60:	df ea                	fucomip %st(2),%st
  62:	77 f4                	ja     58 <main+0x58>
  64:	dd d8                	fstp   %st(0)
  66:	dd d8                	fstp   %st(0)
			}
	}
	...
	exit();
  68:	e8 c5 02 00 00       	call   332 <exit>
  6d:	8d 76 00             	lea    0x0(%esi),%esi
			printf(1, "Parent %d -child %d\n", getpid(), id );
  70:	e8 3d 03 00 00       	call   3b2 <getpid>
  75:	53                   	push   %ebx
  76:	50                   	push   %eax
  77:	68 fc 07 00 00       	push   $0x7fc
  7c:	6a 01                	push   $0x1
  7e:	e8 0d 04 00 00       	call   490 <printf>
			continue;
  83:	83 c4 10             	add    $0x10,%esp
	for ( k = 0; k < n; k++ ) {
  86:	83 c6 01             	add    $0x1,%esi
  89:	39 f7                	cmp    %esi,%edi
  8b:	7f 96                	jg     23 <main+0x23>
	if(id > 0)
  8d:	85 db                	test   %ebx,%ebx
  8f:	7e d7                	jle    68 <main+0x68>
		wait();
  91:	e8 a4 02 00 00       	call   33a <wait>
  96:	eb d0                	jmp    68 <main+0x68>
	n = atoi ( argv[1] ); //from command line
  98:	83 ec 0c             	sub    $0xc,%esp
  9b:	ff 70 04             	pushl  0x4(%eax)
  9e:	e8 1d 02 00 00       	call   2c0 <atoi>
	if ( n < 0 || n > 20 )
  a3:	83 c4 10             	add    $0x10,%esp
  a6:	83 f8 14             	cmp    $0x14,%eax
	n = atoi ( argv[1] ); //from command line
  a9:	89 c7                	mov    %eax,%edi
	if ( n < 0 || n > 20 )
  ab:	76 22                	jbe    cf <main+0xcf>
		n = 2;
  ad:	bf 02 00 00 00       	mov    $0x2,%edi
  b2:	e9 6a ff ff ff       	jmp    21 <main+0x21>
			printf(1, "%d failed in fork!\n", getpid() );
  b7:	e8 f6 02 00 00       	call   3b2 <getpid>
  bc:	52                   	push   %edx
  bd:	50                   	push   %eax
  be:	68 e8 07 00 00       	push   $0x7e8
  c3:	6a 01                	push   $0x1
  c5:	e8 c6 03 00 00       	call   490 <printf>
  ca:	83 c4 10             	add    $0x10,%esp
  cd:	eb b7                	jmp    86 <main+0x86>
	for ( k = 0; k < n; k++ ) {
  cf:	85 c0                	test   %eax,%eax
  d1:	0f 85 4a ff ff ff    	jne    21 <main+0x21>
  d7:	eb 8f                	jmp    68 <main+0x68>
  d9:	66 90                	xchg   %ax,%ax
  db:	66 90                	xchg   %ax,%ax
  dd:	66 90                	xchg   %ax,%ax
  df:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb 2c 08 00 00       	mov    $0x82c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 e4 0a 00 00    	cmp    %eax,0xae4
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 7b7:	0a 00 00 
 7ba:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 7c1:	0a 00 00 
    base.s.size = 0;
 7c4:	b8 e8 0a 00 00       	mov    $0xae8,%eax
 7c9:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 7d0:	00 00 00 
