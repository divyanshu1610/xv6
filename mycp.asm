...
int fd = open(argv[1], O_CREATE | O_RDONLY);
  1a:	68 00 02 00 00       	push   $0x200
  1f:	ff 73 04             	pushl  0x4(%ebx)
  22:	e8 1b 03 00 00       	call   342 <open>

printf(1, "%s\n", argv[2]);
  27:	83 c4 0c             	add    $0xc,%esp
  2a:	ff 73 08             	pushl  0x8(%ebx)
int fd = open(argv[1], O_CREATE | O_RDONLY);
...
int fd1 = open(argv[2], O_CREATE | O_WRONLY);
  3b:	58                   	pop    %eax
  3c:	5a                   	pop    %edx
  3d:	68 01 02 00 00       	push   $0x201
  42:	ff 73 08             	pushl  0x8(%ebx)
  45:	8d 9d e8 fd ff ff    	lea    -0x218(%ebp),%ebx
  4b:	e8 f2 02 00 00       	call   342 <open>
while((sz=read(fd, str,512)) > 0)
  50:	83 c4 10             	add    $0x10,%esp
int fd1 = open(argv[2], O_CREATE | O_WRONLY);
  53:	89 c7                	mov    %eax,%edi
while((sz=read(fd, str,512)) > 0)
  55:	eb 17                	jmp    6e <main+0x6e>
...
write(fd1,str,sz);
  ...
  64:	53                   	push   %ebx
  65:	57                   	push   %edi
  66:	e8 b7 02 00 00       	call   322 <write>
  6b:	83 c4 10             	add    $0x10,%esp
while((sz=read(fd, str,512)) > 0)
  6e:	83 ec 04             	sub    $0x4,%esp
  71:	68 00 02 00 00       	push   $0x200
  76:	53                   	push   %ebx
  77:	56                   	push   %esi
  78:	e8 9d 02 00 00       	call   31a <read>
  7d:	83 c4 10             	add    $0x10,%esp
  80:	85 c0                	test   %eax,%eax
  82:	7f dc                	jg     60 <main+0x60>
printf(1,"%d \t %d\n",fd1, fd);
  84:	56                   	push   %esi
  85:	57                   	push   %edi
  86:	68 bc 07 00 00       	push   $0x7bc
  8b:	6a 01                	push   $0x1
  8d:	e8 ce 03 00 00       	call   460 <printf>
close(fd);
  92:	89 34 24             	mov    %esi,(%esp)
  95:	e8 90 02 00 00       	call   32a <close>
close(fd1);
  9a:	89 3c 24             	mov    %edi,(%esp)
  9d:	e8 88 02 00 00       	call   32a <close>
exit();
 ...
 3c9:	85 d2                	test   %edx,%edx
{
 ...
 3f7:	f7 f1                	div    %ecx
 3f9:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb c5 07 00 00       	mov    $0x7c5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 7c 0a 00 00       	mov    0xa7c,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 736:	e8 f5 fe ff ff       	call   630 <free>
  return freep;
 73b:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
 ...
 764:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 767:	89 15 7c 0a 00 00    	mov    %edx,0xa7c
}
 ...
 779:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 7c 0a 00 00 80 	movl   $0xa80,0xa7c
 787:	0a 00 00 
 78a:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 80 0a 00 00       	mov    $0xa80,%eax
 799:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 7a0:	00 00 00 
